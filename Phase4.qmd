...
PDF ist häufig genug – vor allem, wenn der Reader (Quarto) die eigentliche Lernarbeit trägt.

G. Der End-to-End-Workflow: Von KI-Analyse zu CI-konformen Folien

In der idealen Pipeline ist MARP nicht „ein Tool“, sondern der letzte Produktionsschritt:

Perplexity liefert Quellen und Perspektiven (Recherche)

NotebookLM stabilisiert Wissen (Grounding & Synthese)

Gemini/ChatGPT transformiert in Lernziele, Dramaturgie, Aufgaben (Didaktik)

MARP gießt das Ergebnis in ein reproduzierbares Folienset (Distribution)

Damit wird Folienproduktion zu etwas, das sie immer hätte sein sollen: eine Ableitung, nicht ein Kunstprojekt.

::: {.drag-exercise}
MARP ist der letzte Schritt: Wenn Lernziele, Struktur und Aufgaben bereits stehen, werden Folien zur Ausspielung – nicht zur Denkkrücke.
:::

## Anhang: Bestehender THWS-MARP-Foliensatz (Referenz)

Als Ausgangspunkt können Sie den bestehenden Foliensatz nutzen, der bereits die Basics (Markdown, VS Code, Export, THWS-Themes) abdeckt.

<details><summary>Anhang öffnen: „Präsentationen mit MARP“ (bestehende Folienstruktur)</summary>

Der vorhandene Foliensatz enthält:
